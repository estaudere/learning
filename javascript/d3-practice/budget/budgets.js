...
// make our svgs
var svgGeneral = d3.select("body").append("svg")
...
// -------- CREATE STATIC BARS --------
var svgDebt = d3.select("body").append("svg")
        .attr("width", width + margin.left + margin.right)
        .attr("height", height + margin.top + margin.bottom);
...
var svgFood = d3.select("body").append("svg")
    .attr("width", width + margin.left + margin.right)
    .attr("height", height + margin.top + margin.bottom);
...
// function to generate our static budgets
// returns selection for the bar and the tooltip
